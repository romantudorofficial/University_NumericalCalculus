...
# ---------------------------
# Helper Functions (Numerical Methods)
# ---------------------------
...
# ----- Iterative Methods for Square Matrix Inversion -----
...
# ----- Special Matrix and its Exact Inverse -----
...
# ----- Iterative Method for Non-Square Matrix (Bonus) -----
...
# ---------------------------
class Tema4GUI(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Tema 4: Numerical Calculus & Python Homework")
        self.geometry("900x750")
        self.resizable(False, False)
        self.create_widgets()
    
    def create_widgets(self):
        # Notebook with two tabs: Square Matrix and Non-Square Matrix Inversion
        self.notebook = ttk.Notebook(self)
        self.notebook.pack(fill=tk.BOTH, expand=True)

        # Tab 1: Square Matrix Inversion
        self.tab_square = ttk.Frame(self.notebook)
        self.notebook.add(self.tab_square, text="Square Matrix Inversion")
        self.create_square_tab(self.tab_square)

        # Tab 2: Non-Square Matrix Inversion (Bonus)
        self.tab_rect = ttk.Frame(self.notebook)
        self.notebook.add(self.tab_rect, text="Non-Square Matrix Inversion (Bonus)")
        self.create_rect_tab(self.tab_rect)

    def create_square_tab(self, frame):
        # Input parameters for square matrix inversion
        ...
        # Manual Matrix Input Text (disabled by default)
    ...
    def create_rect_tab(self, frame):
        # Input parameters for non-square (bonus) inversion
        ...
        # Matrix Source Options for Non-Square Matrix
    ...
    def run_square(self):
        # Retrieve basic parameters for square matrix inversion
        try:
    ...
    def run_rect(self):
        # Retrieve parameters for non-square matrix inversion (bonus)
        try:
